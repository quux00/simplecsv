package net.thornydev.simplecsv.resultset;
/**
...
public class ResultSetHelperServiceTest {
  ...
  @Test
  public void getUnsignedIntegerAsLongFromResultSet() throws SQLException, IOException {
    String[] expectedNames = {"Integer", "tinyint", "smallint", "Null"};
    String[] realValues = {String.valueOf(Integer.MAX_VALUE + 200), "2", "3", null};
    String[] expectedValues = {String.valueOf(Integer.MAX_VALUE + 200), "2", "3", ""};
    int[] expectedTypes = {Types.BIGINT, Types.TINYINT, Types.SMALLINT, Types.INTEGER};
